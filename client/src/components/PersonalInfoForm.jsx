// import { BriefcaseBusiness, Globe, MapPin, User, Mail ,Phone} from "lucide-react";
...
//                     handleChange(field.key, e.target.value)} className="mt-1 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring
