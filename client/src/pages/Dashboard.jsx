import { FilePenLineIcon, PenLineIcon, PlusIcon, TrashIcon, UploadCloudIcon, XIcon } from 'lucide-react'
...
const [showUploadResume , setShowUploadResume] = useState(false)
  ...
  return (
   ...
   duration-300 cursor-pointer '>
    ...
    <p className='text-sm from-indigo-300 to-indigo-600 transition-all
    duration-300'>Create Resume
   ...
   duration-300 cursor-pointer '>
    ...
    <p className='text-sm from-indigo-300 to-purple-600 transition-all
    duration-300'>Upload Existing
             ...
             borderColor:baseColor + '40'}}>
              ...
              hidden'>
                <TrashIcon  onClick={()=>deleteResume(resume._id)} className='size-7 p-1.5 hover:bg-white/50 rounded
                 ...
                 <PenLineIcon onClick={()=> {setEditResumeId(resume._id); setTitle(resume.title)}} className='size-7 p-1.5 hover:bg-white/50 rounded
                 text-slate-700 transition-colors'/>
        ...
        z-10 flex items-center justify-center'>
          <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md
           rounded-lg w-full max-w-sm p-6'>
            ...
            <input onChange={(e)=>setTitle(e.target.value)} value={title} type="text" placeholder='Enter resume title' className='w-full px-4
