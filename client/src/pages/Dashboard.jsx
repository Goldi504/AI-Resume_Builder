...
const Dashboard = () => {
  ...
  const createResume = async (event) => {
    try {
      ...
      setTitle("");
      //  setShowCreateResume(`/app/builder/${data.resume._id}`)
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <p
          className="text-2xl font-medium mb-6 bg-gradient-to-r from-slate-700
   ...
   duration-300 cursor-pointer "
    ...
    bg-gradient-to-br from-indigo-300 to-indigo-500 text-white rounded-full"
            />
            <p
              className="text-sm from-indigo-300 to-indigo-600 transition-all
    duration-300"
            >
              Create Resume
            </p>
   ...
   duration-300 cursor-pointer "
    ...
    bg-gradient-to-br from-purple-300 to-purple-500 text-white rounded-full"
            />
            <p
              className="text-sm from-indigo-300 to-purple-600 transition-all
    duration-300"
            >
              Upload Existing
            </p>
